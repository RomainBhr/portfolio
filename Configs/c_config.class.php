...
require_once Chemins::MODELES.'gestion_prix.class.php';
require_once Chemins::MODELES.'gestion_permission.class.php';
require_once Chemins::MODELES.'gestion_cuisine.class.php';
require_once Chemins::MODELES.'gestion_utilisateur.class.php';
require_once Chemins::MODELES.'gestion_alerte.class.php';
require_once Chemins::MODELES.'gestion_categorie.class.php';
require_once Chemins::MODELES.'gestion_options.class.php';
require_once Chemins::MODELES.'gestion_tournee.class.php';
require_once Chemins::MODELES.'gestion_etiquette.class.php';
require_once Chemins::MODELES.'gestion_admin_new_values.class.php';
require_once Chemins::MODELES.'gestion_commande.class.php';
require_once Chemins::MODELES.'gestion_etiquetteSpecial.class.php';
...
//pied de page
$controleurPied = new ControleurCategories();
